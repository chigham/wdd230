...
const mainSectionListItems = document.querySelectorAll("main section ul li")
...
darkModeToggler.addEventListener("click", () => {
    ...
    mainSectionListItems.forEach(listItem => listItem.classList.toggle("main-section-listitems-dark-mode"))
